...
func sierpinski(p1: Point, p2: Point, p3: Point, level: Int, figure: SVG) {
    ...
    draw_triangle(p1: p1, p2: p2, p3: p3)
    sierpinski(p1: p1, p2: midpoint(p1, p2), p3: midpoint(p1, p3), level: level - 1, figure: SVG)
    sierpinski(p1: p2, p2: midpoint(p1, p2), p3: midpoint(p2, p3), level: level - 1, figure: SVG)
    sierpinski(p1: p3, p2: midpoint(p1, p3), p3: midpoint(p2, p3), level: level - 1, figure: SVG)
}
